...
[CustomEditor(typeof(ChipmunkPinJoint))]
[CanEditMultipleObjects]
public class ChipmunkPinJointEditor : ChipmunkEditor
{
	public void OnSceneGUI(){
		ChipmunkPinJoint joint = target as ChipmunkPinJoint;
		if(joint != null && joint._handle == IntPtr.Zero){
			SetupUndo("edited ChipmunkPinJoint");
