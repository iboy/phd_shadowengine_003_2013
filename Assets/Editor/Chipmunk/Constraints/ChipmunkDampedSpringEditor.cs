...
[CustomEditor(typeof(ChipmunkDampedSpring))]
[CanEditMultipleObjects]
public class ChipmunkDampedSpringEditor : ChipmunkEditor
{
	public void OnSceneGUI(){
		ChipmunkDampedSpring joint = target as ChipmunkDampedSpring;
		if(joint != null && joint._handle == IntPtr.Zero){
			SetupUndo("edited ChipmunkDampedSpring");
