...
public class PuppetHelperGeneric_001 : MonoBehaviour {
	...
	private PuppetHelperGeneric_001 genericHelper;
	...
	void Start () {
		...
		genericHelper = (PuppetHelperGeneric_001)FindObjectOfType(typeof(PuppetHelperGeneric_001));
